...
export EXTERNAL_IF_IP4="192.0.2.4/24"
export EXTERNAL_GW_IP4="192.0.2.1"
export EXTERNAL_IF_IP6="2001:db8::4/64"

export LOOPBACK_IF_IP="fd00::4/128"

export BGP_AS="4244444444"
export BGP_ROUTER_ID="4.4.4.4"

export VPN_PEER_PSK="secretpasswordcore"

export VPN_TUNNEL_IF_IP_0="fd00:1:2::1:1/127"
export VPN_PEER_IP4_0="192.0.2.5"
export VPN_PEER_IP6_0="2001:db8::5"
export VPN_PEER_IP_0="${VPN_PEER_IP6_0}"
export BGP_PEER_IP_0="fd00:1:2::1:0"
export BGP_PEER_AS_0="4255555555"

export VPN_TUNNEL_IF_IP_1="fd00:1:2::1:3/127"
export VPN_PEER_IP4_1="192.0.2.6"
export VPN_PEER_IP6_1="2001:db8::6"
export VPN_PEER_IP_1="${VPN_PEER_IP6_1}"
export BGP_PEER_IP_1="fd00:1:2::1:2"
