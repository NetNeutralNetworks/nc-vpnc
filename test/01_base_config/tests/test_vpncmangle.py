...
class TestDNSMangle:
    ...
    def test_dns_query_via_nat64_a_only_record_a_responses(self, host):
        ...
        example_02_v4 = run_cmd(
            host, "dig +short v4lonly.example.com @2001:db8:c57:31::1"
        )
        example_03_v4 = run_cmd(
            host, "dig +short v4lonly.example.com @2001:db8:c58:31::1"
        )
        example_04_v4 = run_cmd(host, "dig +short v4lonly.example.com @fd6c:1:0:31::1")
        example_05_v4 = run_cmd(host, "dig +short v4lonly.example.com @fd6c:1:1:31::1")
    ...
    def test_dns_query_via_nat64_a_only_record_fail_aaaa_responses(self, host):
        ...
        example_00_v4 = run_cmd(
            host, "dig +short v4lonly.example.com AAAA @fdcc:0:c:1::172.16.31.1"
        )
        example_01_v4 = run_cmd(
            host, "dig +short v4lonly.example.com AAAA @fdcc:0:c:1:1::172.17.31.1"
        )
        # example_02_v4 = run_cmd(
        #     host, "dig +short v4lonly.example.com @2001:db8:c57:31::1"
        # )
    ...
    def test_dns_query_via_nat64_mixed_record_a_responses(self, host):
        ...
        example_02_v4 = run_cmd(host, "dig +short v64l.example.com @2001:db8:c57:31::1")
        example_03_v4 = run_cmd(host, "dig +short v64l.example.com @2001:db8:c58:31::1")
        example_04_v4 = run_cmd(host, "dig +short v64l.example.com @fd6c:1:0:31::1")
        example_05_v4 = run_cmd(host, "dig +short v64l.example.com @fd6c:1:1:31::1")
    ...
    def test_dns_query_via_nptv6_mixed_record_aaaa_responses(self, host):
        ...
        example_00_v6 = run_cmd(
            host, "dig +short v64l.example.com AAAA @fdcc:0:c:1::172.16.31.1"
        )
        example_01_v6 = run_cmd(
            host, "dig +short v64l.example.com AAAA @fdcc:0:c:1:1::172.17.31.1"
        )
        example_02_v6 = run_cmd(
            host, "dig +short v64l.example.com AAAA @2001:db8:c57:31::1"
        )
        example_03_v6 = run_cmd(
            host, "dig +short v64l.example.com AAAA @2001:db8:c58:31::1"
        )
        example_04_v6 = run_cmd(
            host, "dig +short v64l.example.com AAAA @fd6c:1:0:31::1"
        )
        example_05_v6 = run_cmd(
            host, "dig +short v64l.example.com AAAA @fd6c:1:1:31::1"
        )
    ...
    def test_dns_query_via_nptv6_aaaa_only_record_aaaa_responses(self, host):
        ...
        example_00_v6 = run_cmd(
            host, "dig +short v6lonly.example.com AAAA @fdcc:0:c:1::172.16.31.1"
        )
        example_01_v6 = run_cmd(
            host, "dig +short v6lonly.example.com AAAA @fdcc:0:c:1:1::172.17.31.1"
        )
        example_02_v6 = run_cmd(
            host, "dig +short v6lonly.example.com AAAA @2001:db8:c57:31::1"
        )
        example_03_v6 = run_cmd(
            host, "dig +short v6lonly.example.com AAAA @2001:db8:c58:31::1"
        )
        example_04_v6 = run_cmd(
            host, "dig +short v6lonly.example.com AAAA @fd6c:1:0:31::1"
        )
        example_05_v6 = run_cmd(
            host, "dig +short v6lonly.example.com AAAA @fd6c:1:1:31::1"
        )
    ...
    def test_dns_query_via_nptv6_aaaa_only_record_fail_a_responses(self, host):
        ...
        example_00_v4 = run_cmd(
            host, "dig +short v6lonly.example.com A @fdcc:0:c:1::172.16.31.1"
        )
        example_01_v4 = run_cmd(
            host, "dig +short v6lonly.example.com A @fdcc:0:c:1:1::172.17.31.1"
        )
    ...
    def test_dns_query_via_non_nptv6_aaaa_only_record_fail_aaaa_responses(self, host):
        ...
        example_00_v6 = run_cmd(
            host, "dig +short v6gonly.example.com AAAA @fdcc:0:c:1::172.16.31.1"
        )
        example_01_v6 = run_cmd(
            host, "dig +short v6gonly.example.com AAAA @fdcc:0:c:1:1::172.17.31.1"
        )
